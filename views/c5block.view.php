...
\Nos\Nos::main_controller()->addJavascript('static/apps/c5block/js/jquery.min.js');
\Nos\Nos::main_controller()->addJavascript('static/apps/c5block/js/SimpleJSXslt.js');
\Nos\Nos::main_controller()->addJavascript('static/apps/c5block/js/myjquery.js');
?><!DOCTYPE html>
<html>
<head>
    <meta charset="UTF-8" />
